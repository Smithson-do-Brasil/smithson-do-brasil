        ...
        {data.map((partner, index) => (
          ...
          >
            ...
            >
              ...
              <div className="absolute z-50 h-full w-full bg-[rgba(255,255,255,0.5)] transition-all hover:bg-transparent dark:bg-[rgba(0,0,0,0.6)] hover:dark:bg-transparent"></div>
            </a>
          </CarouselItem>
        ))}
      </CarouselContent>
